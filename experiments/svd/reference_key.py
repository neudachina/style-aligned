...
def svd_exp(prompt, image_name='output', seed=0):
    ...
    base_path = './images/reference/ts-biggest-both-key/'
    ...
    for i in range(len(timestamps) - 1):
        ...
        current_images = []
        for j in range(1, 6):
            sa_args.svd_reference_key_end = j
...
def svd_exp(prompt, image_name='output', seed=0):
    ...
    base_path = './images/reference/ts-smallest-both-key/'
    Path(base_path).mkdir(parents=True, exist_ok=True)
    ...
    for i in range(len(timestamps) - 1):
        ...
        current_images = []
        for j in range(6):
            sa_args.svd_reference_key_start = j
...
def svd_exp(prompt, image_name='output', seed=0):
    ...
    base_path = './images/reference/ts-biggest-positive-key/'
    Path(base_path).mkdir(parents=True, exist_ok=True)
    ...
    sa_args.svd_reference_key = True
    sa_args.svd_reference_key_positive = True
    sa_args.svd_reference_key_negative = False
    sa_args.svd_reference_key_start = 0
...
def svd_exp(prompt, image_name='output', seed=0):
    ...
    base_path = './images/reference/ts-smallest-positive-key/'
    Path(base_path).mkdir(parents=True, exist_ok=True)
...
def svd_exp(prompt, image_name='output', seed=0):
    ...
    base_path = './images/reference/ts-biggest-negative-key/'
    Path(base_path).mkdir(parents=True, exist_ok=True)
    ...
    sa_args.svd = True
    sa_args.svd_reference_key = True
    sa_args.svd_reference_key_positive = False
    sa_args.svd_reference_key_negative = True
    sa_args.svd_reference_key_start = 0
...
def svd_exp(prompt, image_name='output', seed=0):
    ...
    base_path = './images/reference/ts-smallest-negative-key/'
    Path(base_path).mkdir(parents=True, exist_ok=True)
